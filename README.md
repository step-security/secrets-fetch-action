...
> NOTE: If the GitHub Actions for your repository only require secrets from a single config, we recommend using [Doppler GitHub application](https://github.com/apps/doppler-secretops-platform/) instead, as it syncs secrets directly to your repository.
...
jobs:
  your-example-job:
    ...
    steps:
      - uses: step-security/secrets-fetch-action@v2
        id: doppler
        with:
           auth-method: oidc        
